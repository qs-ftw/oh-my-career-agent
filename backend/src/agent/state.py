...
class CareerAgentState(TypedDict, total=False):
    ...
    skip_review: bool  # Skip jd_review node for faster response
    ...
    # Phase 3: multi-step tailoring
    jd_keywords: dict[str, Any] | None           # keyword extraction result
    selected_content: dict[str, Any] | None       # selected projects/experiences
    keyword_coverage: dict[str, Any] | None       # coverage check result
    resume_patches: list[dict[str, Any]]          # patches for uncovered keywords
