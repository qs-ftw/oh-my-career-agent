...
This module is invoked by ``alembic upgrade head`` and friends.  It sets up
an **async** SQLAlchemy engine from the same DATABASE_URL used by the FastAPI
app and imports all ORM models so that autogenerate can detect schema changes.
"""
